    ...
    <List className="p-0 mt-4 mb-6 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
      ...
      <Link to="/blog">
        <Typography
          ...
          // className="font-bold"
        >
          <ListItem className={styleListItem}>BLOG</ListItem>
        </Typography>
      </Link>
    </List>
  );
...
export function Header() {
  ...
  return (
    <div className="">
        <Banner/>
    <Navbar className="max-w-full px-4 py-2 mx-auto border-none rounded-none drop-shadow-2xl">
      ...
      <Typography
        ...
        <div className="hidden gap-2 lg:flex"> 
          ...
          <div className="flex items-center gap-4"> 
              ...
              <input className="block w-full py-3 pr-12 bg-white border rounded-full shadow-md placeholder:italic placeholder:text-gray-600 border-slate-300 pl-9 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Tìm kiếm..." type="text" name="search"/>
            </label>
          <Button className="flex items-center gap-3 bg-black text-white rounded-full p-2 px-4 transition transform hover:-translate-y-0.5 duration-200" >
      ...
      <Link to="/account">
       ...
       {/* <Link to="/account">
        ...
        {/* <hr className="my-3" /> */}
        <MenuItem className="flex items-center" onClick={setOpenChangePasswordDialog}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-3 size-6">
    ...
    <Dialog open={openChangePasswordDialog} handler={setOpenChangePasswordDialog}>
        ...
        <DialogFooter>
          <Button variant="text" color="red" onClick={() => setOpenChangePasswordDialog(false)}>
            Hủy
          </Button>
          <Button variant="gradient" color="green" onClick={() => setOpenChangePasswordDialog(false)}>
            Lưu
          </Button>
        </DialogFooter> */}
        <ChangePasswordForm/>
