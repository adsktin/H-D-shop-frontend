            ...
            <table className="min-w-full border-collapse border border-gray-300">
                <thead>
                    <tr className="bg-gray-200">
                        ...
                        <th className="border border-gray-300 px-4 py-2">Phiên bản</th>
                        ...
                        products.map((product) => (
                            <tr key={product.id}>
                                <td className="border border-gray-300 px-4 py-2">
                                    <img src={URL.createObjectURL(product.imageFile)} alt={product.productName} className="h-10 w-10 object-cover rounded" />
                                </td>
                                <td className="border border-gray-300 px-4 py-2">{product.productName}</td>
                                <td className="border border-gray-300 px-4 py-2">{product.version}</td>
