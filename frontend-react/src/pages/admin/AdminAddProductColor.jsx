...
const AdminAddProductColor = ({ onSave, selectedColor, onCancel }) => {
...
AdminAddProductColor.propTypes = {
...
AdminAddProductColor.defaultProps = {
  selectedColor: null,
};

export default AdminAddProductColor;
